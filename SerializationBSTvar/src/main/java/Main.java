...
//        }
        ...
        var szo = "Szo";        // Lokális változóknál használhatjuk, mindig inicializálni kell
        var szam = 10;          // A típusa az incializált érték alapján dől el
        var polo$ka = "polos";
        try {
